package com.chenenru.gmall.payment.mq;
...
/**
 * @Author chenenru
 * @ClassName PaymentServiceMqListener
 * @Description
 * @Date 2020/2/26 23:46
 * @Version 1.0
 **/
@Component
    ...
    public void consumePaymentCheckResult(MapMessage mapMessage) throws JMSException {
        ...
        if(resultMap!=null&&!resultMap.isEmpty()){
            ...
            if(StringUtils.isNotBlank(trade_status)&&trade_status.equals("TRADE_SUCCESS")){
                ...
                System.out.println("JmsListener的updatePayment前的paymentInfo："+paymentInfo);
                ...
                System.out.println("JmsListener的updatePayment后的paymentInfo："+paymentInfo);
                return;
            }
        }
